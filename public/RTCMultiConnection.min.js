...
window.RTCMultiConnection = function(roomid, forceOptions) {
        ...
        connection.socket.on(connection.socketMessageEvent, function(message) {
            if (message.remoteUserId == connection.userid) {
                ...
                if ("removeFromBroadcastersList" === message.message)
                    return void (connection.broadcasters.indexOf(message.sender) !== -1 && (delete connection.broadcasters[connection.broadcasters.indexOf(message.sender)],
        ...
        this.getLocalConfig = function(remoteSdp, remoteUserId, userPreferences) {
            return userPreferences || (userPreferences = {}),
            {
                ...
                onPeerStateChanged: function(states) {
                    ...
                    states.iceConnectionState.search(/closed|failed/gi) !== -1 && (self.onUserLeft(remoteUserId),
    ...
    function PeerInitiator(config) {
        ...
        if ("undefined" != typeof window.RTCPeerConnection ? RTCPeerConnection = window.RTCPeerConnection : "undefined" != typeof mozRTCPeerConnection ? RTCPeerConnection = mozRTCPeerConnection : "undefined" != typeof webkitRTCPeerConnection && (RTCPeerConnection = webkitRTCPeerConnection),
        ...
        renegotiatingPeer)
            ...
            try {
                ...
                connection.iceServers.length || (params = null,
        ...
        peer.addEventListener(incomingStreamEvent, function(event) {
            if (event && ("track" === incomingStreamEvent && (event.stream = event.streams[event.streams.length - 1]),
            !dontDuplicate[event.stream.id])) {
                ...
                event.stream.isScreen = streamToShare.isScreen) : (event.stream.isVideo = !!event.stream.getVideoTracks().length,
        ...
        this.addRemoteSdp = function(remoteSdp, cb) {
            ...
            ,
            window.enableAdapter ? (remoteSdp.sdp = connection.processSdp(remoteSdp.sdp),
            void peer.setRemoteDescription(new RTCSessionDescription(remoteSdp)).then(cb, function(error) {
                connection.enableLogs && console.error("setRemoteDescription failed", "\n", error, "\n", remoteSdp.sdp),
                cb()
    ...
    function getUserMediaHandler(options) {
        ...
        if (currentUserMediaRequest.streams[idInstance])
            ...
            if (window.enableAdapter || "Safari" !== DetectRTC.browser.name || (options.localMediaConstraints.audio !== !1 && (options.localMediaConstraints.audio = !0),
            options.localMediaConstraints.video !== !1 && (options.localMediaConstraints.video = !0)),
    ...
    function onMessageCallback(data) {
        ...
        data.sourceId && screenCallback && (sourceId = data.sourceId,
    ...
    function getScreenConstraints(callback, audioPlusTab) {
        ...
        return "Firefox" === DetectRTC.browser.name ? callback(null, firefoxScreenConstraints) : (sourceId = null,
        void isChromeExtensionAvailable(function(isAvailable) {
            ...
            return window.IsAndroidChrome ? void callback(null, screen_constraints) : "desktop" != chromeMediaSource || sourceId ? ("desktop" == chromeMediaSource && (screen_constraints.mandatory.chromeMediaSourceId = sourceId),
            sourceId = null,
            chromeMediaSource = "screen",
            screenCallback = null,
    ...
    !function() {
        function getBrowserInfo() {
            ...
            if (isOpera) {
                ...
                (verOffset = nAgt.indexOf("Version")) !== -1 && (fullVersion = nAgt.substring(verOffset + 8))) : isFirefox ? (verOffset = nAgt.indexOf("Firefox"),
                browserName = "Firefox",
            ...
            (ix = fullVersion.indexOf(";")) !== -1 && (fullVersion = fullVersion.substring(0, ix)),
            (ix = fullVersion.indexOf(" ")) !== -1 && (fullVersion = fullVersion.substring(0, ix)),
        ...
        function checkDeviceSupport(callback) {
            ...
            navigator.enumerateDevices(function(devices) {
                devices.forEach(function(_device) {
                    ...
                    alreadyUsedDevices[device.deviceId + device.label] || ("audio" === device.kind && (device.kind = "audioinput"),
                    ...
                    DetectRTC.browser.isChrome && DetectRTC.browser.version >= 46 && !/^(https:|chrome-extension:)$/g.test(location.protocol || "") && document.domain.search && document.domain.search(/localhost|127.0./g) === -1 && (device.label = "HTTPs is required to get label of this " + device.kind + " device.")),
                    "audioinput" === device.kind && (hasMicrophone = !0,
                    audioInputDevices.indexOf(device) === -1 && audioInputDevices.push(device)),
                    "audiooutput" === device.kind && (hasSpeakers = !0,
                    audioOutputDevices.indexOf(device) === -1 && audioOutputDevices.push(device)),
                    "videoinput" === device.kind && (hasWebcam = !0,
                    videoInputDevices.indexOf(device) === -1 && videoInputDevices.push(device)),
        ...
        var browserFakeUserAgent = "Fake/5.0 (FakeOS) AppleWebKit/123 (KHTML, like Gecko) Fake/12.3.4567.89 Fake/123.45"
          , isNodejs = "object" == typeof process && "object" == typeof process.versions && process.versions.node;
        if (isNodejs) {
        ...
        osInfo && osInfo.osName && "-" != osInfo.osName ? (osName = osInfo.osName,
        osVersion = osInfo.osVersion) : isMobile.any() && (osName = isMobile.getOsName(),
        ...
        "Unknown OS" === osName && isNodejs && (osName = "Nodejs",
        ...
        var isWebRTCSupported = ("object" == typeof process && "object" == typeof process.versions && process.versions["node-webkit"],
        !1);
        ...
        /^(https:|chrome-extension:)$/g.test(location.protocol || "") || (document.domain.search && document.domain.search(/localhost|127.0./g) === -1 && (isScreenCapturingSupported = !1),
        ...
        ["AudioContext", "webkitAudioContext", "mozAudioContext", "msAudioContext"].forEach(function(item) {
            ...
            window[item] && "createMediaStreamSource"in window[item].prototype && (webAudio.isCreateMediaStreamSourceSupported = !0))
        }),
        ...
        DetectRTC.browser.isChrome && DetectRTC.browser.version >= 46 && !/^(https:|chrome-extension:)$/g.test(location.protocol || "") && document.domain.search && document.domain.search(/localhost|127.0./g) === -1 && (isGetUserMediaSupported = "Requires HTTPs"),
        ...
        "Chrome" == DetectRTC.browser.name && DetectRTC.browser.version >= 53 && (DetectRTC.isCanvasSupportsStreamCapturing || (DetectRTC.isCanvasSupportsStreamCapturing = "Requires chrome flag: enable-experimental-web-platform-features"),
        ...
        "Nodejs" === DetectRTC.osName && (DetectRTC.isWebSocketsSupported = !0,
    ...
    navigator && navigator.userAgent && navigator.userAgent.indexOf("Crosswalk") !== -1 && (DetectRTC.isMobileDevice = !0,
    DetectRTC.browser.name = "Chrome"),
    ...
    "undefined" == typeof window.enableAdapter && ("Firefox" === DetectRTC.browser.name && DetectRTC.browser.version >= 54 && (window.enableAdapter = !0),
    "Chrome" === DetectRTC.browser.name && DetectRTC.browser.version >= 60,
    "undefined" != typeof adapter && adapter.browserDetails && "string" == typeof adapter.browserDetails.browser && (window.enableAdapter = !0)),
    ...
    var OnIceCandidateHandler = function() {
      ...
      , IceServersHandler = function() {
        function getIceServers(connection) {
            var iceServers = [{
                urls: ["turn:webrtcweb.com:7788", "turn:webrtcweb.com:4455"],
                username: "muazkh",
                credential: "muazkh"
            }, {
                urls: ["stun:stun.l.google.com:19302"]
            }];
            return "Firefox" === DetectRTC.browser.name && DetectRTC.browser.version >= 54 && (iceServers[0].urls = [iceServers[0].urls[0]]),
            iceServers
        }
        return {
    ...
    var StreamsHandler = function() {
        function handleType(type) {
            if (type)
                return "string" == typeof type || "undefined" == typeof type ? type : type.audio && type.video ? null : type.audio ? "audio" : type.video ? "video" : void 0
        }
            ...
            if (stream && stream.addEventListener) {
                ...
                stream.unmute = function(type, isSyncAction) {
                    ...
                    "undefined" != typeof type && "video" == type && connection.streamEvents[stream.streamid].isAudioMuted && !function looper(times) {
                        times || (times = 0),
                        times++,
                        times < 100 && connection.streamEvents[stream.streamid].isAudioMuted && (stream.mute("audio"),
                        setTimeout(function() {
                            looper(times)
                        }, 50))
                    }()),
    ...
    !function(connection) {
        ...
        connection.deletePeer = function(remoteUserId) {
            if (remoteUserId) {
                ...
                if (connection.peersBackup[eventObject.userid] && (eventObject.extra = connection.peersBackup[eventObject.userid].extra),
                connection.onleave(eventObject),
        ...
        connection.processSdp = function(sdp) {
            return "Firefox" === DetectRTC.browser.name ? sdp : ((connection.bandwidth.video || connection.bandwidth.screen) && (sdp = CodecsHandler.setApplicationSpecificBandwidth(sdp, connection.bandwidth, !!connection.session.screen)),
            connection.bandwidth.video && (sdp = CodecsHandler.setVideoBitrates(sdp, {
        ...
        connection.addStream = function(session, remoteUserId) {
            ...
            return session.getAudioTracks ? (connection.attachStreams.indexOf(session) === -1 && (session.streamid || (session.streamid = session.id),
            ...
            void connection.renegotiate(remoteUserId)) : isData(session) ? void connection.renegotiate(remoteUserId) : void ((session.audio || session.video || session.screen) && (session.screen ? connection.getScreenConstraints(function(error, screen_constraints) {
                return error ? "PermissionDeniedError" === error ? (session.streamCallback && session.streamCallback(null),
                void (connection.enableLogs && console.error("User rejected to share his screen."))) : alert(error) : void connection.invokeGetUserMedia({
                    audio: !!isAudioPlusTab(connection) && getAudioScreenConstraints(screen_constraints),
                    video: screen_constraints,
                    isScreen: !0
        ...
        connection.setStreamEndHandler = function(stream, isRemote) {
            if (stream && stream.addEventListener && (isRemote = !!isRemote,
            !stream.alreadySetEndHandler)) {
                stream.alreadySetEndHandler = !0;
                var streamEndedEvent = "ended";
                "oninactive"in stream && (streamEndedEvent = "inactive"),
                stream.addEventListener(streamEndedEvent, function() {
                    if (stream.idInstance && currentUserMediaRequest.remove(stream.idInstance),
                    !isRemote) {
                        var streams = [];
                    ...
                    streamEvent.userid === connection.userid && "remote" === streamEvent.type || (connection.peersBackup[streamEvent.userid] && (streamEvent.extra = connection.peersBackup[streamEvent.userid].extra),
                    connection.onstreamended(streamEvent),
                    delete connection.streamEvents[stream.streamid])
                }, !1)
            }
        ...
        connection.addNewBroadcaster = function(broadcasterId, userPreferences) {
            ...
            connection.session.oneway || connection.session.broadcast || "many-to-many" !== connection.direction || connection.broadcasters.indexOf(broadcasterId) !== -1 || (connection.broadcasters.push(broadcasterId),
            keepNextBroadcasterOnServer()))
        }
        ,
        ...
        connection.closeSocket = function() {
            ...
            connection.socket && ("function" == typeof connection.socket.disconnect && connection.socket.disconnect(),
            "function" == typeof connection.socket.resetProps && connection.socket.resetProps(),
        ...
        navigator && navigator.connection && navigator.connection.type && (connection.isLowBandwidth = navigator.connection.type.toString().toLowerCase().search(/wifi|cell/g) !== -1,
